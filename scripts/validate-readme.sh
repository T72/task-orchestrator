...
# 1. GOLDEN CIRCLE FRAMEWORK (40 points)
echo -e "${BLUE}🎯 Golden Circle Framework Analysis${NC}"
echo -e "${BLUE}────────────────────────────────────${NC}"

check_element "WHY Section" \
    "why.*our mission\|why.*we exist\|why.*our purpose" \
    15 true \
    "Must start with purpose/belief statement"
